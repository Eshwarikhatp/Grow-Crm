    ...
    <div class="x-title wordwrap" id="kanban_lead_title_<?php echo e($lead->lead_id); ?>"><?php echo e($lead->lead_title); ?>
        ...
        <div class="dropdown-menu dropdown-menu-small dropdown-menu-right js-stop-propagation"
            ...
            <a class="dropdown-item edit-add-modal-button js-ajax-ux-request reset-target-modal-form" data-toggle="modal"
                data-target="#commonModal" data-modal-title="<?php echo app('translator')->get('lang.clone_lead'); ?>"
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH /var/www/html/GROWCRM/GROWCRM/application/resources/views/pages/leads/components/kanban/card.blade.php ENDPATH**/ ?>