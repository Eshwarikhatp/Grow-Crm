...
<form class="form" id="settingsFormGeneral">
    ...
    <div class="form-group row">
        ...
        <div class="form-group row">
            <label for="example-month-input" class="col-12 col-form-label text-left"><?php echo app('translator')->get('lang.exporting_content'); ?> - (<?php echo app('translator')->get('lang.strip_html'); ?>)</label>
            <div class="col-12">
                <select class="select2-basic form-control form-control-sm"
                    id="settings_system_exporting_strip_html"
...
<?php echo $__env->make('pages.settings.ajaxwrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/GROWCRM/GROWCRM/application/resources/views/pages/settings/sections/general/general.blade.php ENDPATH**/ ?>