...
<div class="col-12">
    ...
    <div class="docs-main-wrapper editing-mode box-shadow">
        ...
        <div class="doc-body">
            ...
            <!--signatures (signed) -->
            <?php if($document->doc_status == 'accepted'): ?>
            <?php echo $__env->make('pages.documents.elements.signatures', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php endif; ?>
...
<?php echo $__env->make('pages.documents.wrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/GROWCRM/GROWCRM/application/resources/views/pages/documents/preview/page.blade.php ENDPATH**/ ?>