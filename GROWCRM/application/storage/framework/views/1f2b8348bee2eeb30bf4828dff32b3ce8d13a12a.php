            ...
            <table>
                <tbody>
                    ...
                    <tr id="document_dates_section_5">
                        ...
                        <td class="x-left-id p-l-25 p-t-10">
                            <span><?php echo e(runtimeMoneyFormat($document->bill_final_amount ?? 0)); ?></span>
                        </td>
                    </tr>
                    <!--status-->
                    <tr id="document_dates_section_6">
                        ...
                        <td class="x-right-status  p-t-4 p-l-25">
                            <span class="x-right-label">
                                <?php if($document->doc_type == 'proposal'): ?>
                                <label class="label label-rounded m-b-0 m-t-6 p-l-15 p-r-15 <?php echo e(runtimeProposalStatusColors($document->doc_status, 'label')); ?>"
                                    id="document-status-label"><?php echo e(runtimeLang($document->doc_status)); ?></label>
                                <?php else: ?>
                                <label class="label label-rounded m-b-0 m-t-6 p-l-15 p-r-15 runtimeProposalStatusColors<?php echo e(runtimeContractStatusColors($document->doc_status, 'label')); ?>"
                                    id="document-status-label"><?php echo e(runtimeLang($document->doc_status)); ?></label>
                                <?php endif; ?>
                            </span>
                        </td>
...
</div><?php /**PATH /var/www/html/GROWCRM/GROWCRM/application/resources/views/pages/documents/elements/doc-details.blade.php ENDPATH**/ ?>