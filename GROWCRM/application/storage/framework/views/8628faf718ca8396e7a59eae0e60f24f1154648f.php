...
<aside class="left-sidebar" id="js-trigger-nav-team">
            ...
            <ul id="sidebarnav" data-modular-id="main_menu_team">
                ...
                <li data-modular-id="main_menu_team_clients"
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <?php endif; ?>
                        <!--contracts [hidden]-->
                        <?php if(config('visibility.modules.contracts.foo')): ?>
    ...
    <!-- End Sidebar scroll-->
</aside><?php /**PATH /var/www/html/GROWCRM/GROWCRM/application/resources/views/nav/leftmenu-team.blade.php ENDPATH**/ ?>