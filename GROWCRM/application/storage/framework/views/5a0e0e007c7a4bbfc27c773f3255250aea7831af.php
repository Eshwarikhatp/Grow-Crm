...
<tr id="projects_<?php echo e($project->project_id); ?>">
    ...
    <td class="projects_col_action actions_column">
        ...
        <span class="list-table-action dropdown font-size-inherit">
            ...
            <!--view-->
            <a href="/templates/projects/<?php echo e($project->project_id); ?>" title="<?php echo e(cleanLang(__('lang.view'))); ?>"
...
<!--each row--><?php /**PATH /var/www/html/GROWCRM/GROWCRM/application/resources/views/pages/templates/projects/components/table/ajax.blade.php ENDPATH**/ ?>