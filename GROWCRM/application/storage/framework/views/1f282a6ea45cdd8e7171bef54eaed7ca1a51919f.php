...
<div class="col-md-12  col-lg-6 align-self-center text-right parent-page-actions p-b-9"
    ...
    <div id="list-page-actions">
        ...
        <!--delete proposal-->
        <?php if(config('visibility.delete_proposal_button')): ?>
        <!--delete-->
        <button type="button" data-toggle="tooltip" title="<?php echo e(cleanLang(__('lang.delete_proposal'))); ?>"
            ...
            data-url="<?php echo e(url('/proposals/'.$document->proposal_id.'?source=page')); ?>"><i
                class="sl-icon-trash"></i></button>
        <?php endif; ?>
    </div>
</div>
<!-- action buttons --><?php /**PATH /var/www/html/GROWCRM/GROWCRM/application/resources/views/pages/documents/components/proposal/actions-team.blade.php ENDPATH**/ ?>