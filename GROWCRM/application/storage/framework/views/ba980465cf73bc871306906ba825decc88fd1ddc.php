...
<form class="form" id="settingsFormFolders">
        ...
        <div class="form-group form-group-checkbox row">
            ...
            <div class="col-sm-12 col-lg-8 text-left p-t-5">
                <input type="checkbox" id="settings2_file_folders_manage_assigned"
                    name="settings2_file_folders_manage_assigned" class="filled-in chk-col-light-blue" <?php echo e(runtimePrechecked($settings->settings2_file_folders_manage_assigned ?? '')); ?>>
        ...
        <div class="form-group form-group-checkbox row">
            ...
            <div class="col-sm-12 col-lg-8 text-left p-t-5">
                <input type="checkbox" id="settings2_file_folders_manage_project_manager"
                    name="settings2_file_folders_manage_project_manager" class="filled-in chk-col-light-blue" <?php echo e(runtimePrechecked($settings->settings2_file_folders_manage_project_manager ?? '')); ?>>
        ...
        <div class="form-group form-group-checkbox row">
            ...
            <div class="col-sm-12 col-lg-8 text-left p-t-5">
                <input type="checkbox" id="settings2_file_folders_manage_client"
                    name="settings2_file_folders_manage_client" class="filled-in chk-col-light-blue" <?php echo e(runtimePrechecked($settings->settings2_file_folders_manage_client ?? '')); ?>>
    ...
    <div class="text-right">
        <button type="submit" id="commonModalSubmitButton" class="btn btn-rounded-x btn-danger waves-effect text-left ajax-request"
            data-url="/settings/files/folders" data-loading-target="" data-ajax-type="PUT" data-type="form"
            data-on-start-submit-button="disable"><?php echo e(cleanLang(__('lang.save_changes'))); ?></button>
    </div>

</form>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('pages.settings.ajaxwrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/GROWCRM/GROWCRM/application/resources/views/pages/settings/sections/files/folders.blade.php ENDPATH**/ ?>