...
<form class="form">
    ...
    <div class="form-group row">
        <label class="col-sm-12 col-lg-4 text-left control-label col-form-label"><?php echo app('translator')->get('lang.manage_task_dependencies'); ?></label>
        <div class="col-sm-12 col-lg-8">
            <select class="select2-basic form-control form-control-sm select2-preselected" id="settings2_tasks_manage_dependencies"
                name="settings2_tasks_manage_dependencies" data-preselected="<?php echo e(config('system.settings2_tasks_manage_dependencies')); ?>">
...
<?php echo $__env->make('pages.settings.ajaxwrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/GROWCRM/GROWCRM/application/resources/views/pages/settings/sections/tasks/page.blade.php ENDPATH**/ ?>