    ...
    <div id="list-page-actions" class="hidden pull-right w-px-400 select-email-template-dropdown"
        ...
        <form id="fix-form-email-templates">
            <select class="select2-basic form-control form-control-sm text-left" data-url="" id="selectEmailTemplate"
                ...
                <!--contract [hidden]--
                <optgroup class="hidden" label="[ <?php echo e(cleanLang(__('lang.contracts'))); ?> ]">
            ...
            -->
                ...
                <!--modules-->
                <optgroup label="[ <?php echo e(cleanLang(__('lang.modules'))); ?> ]">
...
<?php echo $__env->make('pages.settings.ajaxwrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/GROWCRM/GROWCRM/application/resources/views/pages/settings/sections/email/templates/welcome.blade.php ENDPATH**/ ?>