...
<form class="form">
    ...
    <div>
        ...
        <a href="https://growcrm.io/documentation/theme/" target="_blank" class="btn btn-sm btn-info"><i
                class="ti-info-alt"></i> <?php echo e(cleanLang(__('lang.help_documentation'))); ?></a>
    </div>
    <!--buttons-->
...
<?php echo $__env->make('pages.settings.ajaxwrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/GROWCRM/GROWCRM/application/resources/views/pages/settings/sections/theme/page.blade.php ENDPATH**/ ?>