...
namespace App\Http\Responses\Screenshots;
...
class IndexResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        if (request('source') == 'ext' || request('action') == 'search' || request()->ajax()) {
            ...
            $html = view($template, compact('page', 'tickets', 'stats', 'categories', 'fields'))->render();
            ...
            return view('pages/tickets/wrapper', compact('page', 'tickets', 'stats', 'categories', 'fields'))->render();
        }
