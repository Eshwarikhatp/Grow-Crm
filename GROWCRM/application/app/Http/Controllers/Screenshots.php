...
use App\Http\Requests\Screenshots\TicketStoreUpdate;
use App\Http\Responses\Screenshots\CreateResponse;
use App\Http\Responses\Screenshots\DestroyResponse;
use App\Http\Responses\Screenshots\EditResponse;
use App\Http\Responses\Screenshots\IndexResponse;
use App\Http\Responses\Screenshots\ReplyResponse;
use App\Http\Responses\Screenshots\ShowResponse;
use App\Http\Responses\Screenshots\StoreReplyResponse;
use App\Http\Responses\Screenshots\StoreResponse;
use App\Http\Responses\Screenshots\UpdateResponse;
...
class Screenshots extends Controller {
    ...
    public function index(CategoryRepository $categoryrepo) {
        ...
        //get tickets
        $screenshots = $this->ticketrepo->search();
        ...
        //reponse payload
        $payload = [
            'page' => $this->pageSettings('screenshots'),
